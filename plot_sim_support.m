...
model.plot({...
    'sitfac','anxiety',...
    'hr','breathing_f','anxiety_regulation','chest_c'
});
model.plot({'chest_c'});
model.plot({...
...
model.plot({'ps'});
%model.plot({'anxiety','anxiety_regulation'});
%model.plot({'anxiety','graph_bel_anxiety','support'});
model.plot({...
    'graph_bel_used_chest_range'...
    'graph_stable_hr','graph_stable_bf'...
    'anxiety',...
    'graph_bel_anxiety','assessment',...
    'support','cycle_time','chest_c'
});

%%
model.plot({'anxiety','ps','hr','breathing_f','anxiety_regulation'});
model.plot({...
    'graph_bel_starting_dir'...
    'breathing_f'...
    'graph_bel_breathing_f'...
